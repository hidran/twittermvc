      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="index.php">Your timeline <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="?showMyTweets=1">Your tweets</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="users.php">Public profiles</a>
          </li>
        </ul>
