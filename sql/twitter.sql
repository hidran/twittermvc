...
--
-- Host: localhost
-- Generation Time: Mar 23, 2021 at 11:25 PM
-- Server version: 5.7.24
-- PHP Version: 8.0.1
...
INSERT INTO `followers` (`id`, `follower`, `followed`, `following`) VALUES
(1, 1, 4, 1),
(2, 1, 2, 1);
...
ALTER TABLE `followers`
    ADD PRIMARY KEY (`id`),
    ADD UNIQUE KEY `udx_follower_followed` (`follower`,`followed`),
...
ALTER TABLE `followers`
    ...
    ADD CONSTRAINT `fk_follower` FOREIGN KEY (`follower`) REFERENCES `users` (`id`);
COMMIT;
